...
function M.setup()
  ...
  local highlights = {
    ...
    Keyword = { fg = colors.keyword or "#fd8da3" },
    String = { fg = colors.string or "#77d5a3" },
    Constant = { fg = colors.constant or "#92a9ff" },
    Function = { fg = colors.function_name or "#bd9cfe" },
    Identifier = { fg = colors.variable or "#ffd395" },
    Type = { fg = colors.type or "#92a9ff" },
    Statement = { fg = colors.keyword or "#fd8da3" },
    PreProc = { fg = colors.keyword or "#fd8da3" },
    Special = { fg = colors.string or "#77d5a3" },
    ...
    ["@field"] = { fg = colors.type or "#85cdf1" },
    ["@property"] = { fg = colors.type or "#85cdf1" },
    ["@namespace"] = { fg = colors.function_name or "#bd9cfe" },
    ["@tag"] = { fg = colors.string or "#77d5a3" },
    ["@punctuation"] = { fg = colors.fg },
    ["@operator"] = { fg = colors.fg },
    ["@number"] = { fg = colors.constant or "#92a9ff" },
    ["@boolean"] = { fg = colors.constant or "#92a9ff" },
    ["@error"] = { fg = colors.error },
    ["@warning"] = { fg = colors.warning },
    
    -- Markdown
    markdownH1 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownH2 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownH3 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownH4 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownH5 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownH6 = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownHeadingDelimiter = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    markdownHeadingRule = { fg = colors.border },
    markdownBold = { fg = colors.markdown_bold or "#ffd395", bold = true },
    markdownItalic = { fg = colors.markdown_italic or "#85cdf1", italic = true },
    markdownCode = { fg = colors.markdown_code or "#92a9ff" },
    markdownCodeBlock = { fg = colors.markdown_code or "#92a9ff", bg = colors.line_highlight },
    markdownCodeDelimiter = { fg = colors.markdown_code or "#92a9ff" },
    markdownInlineCode = { fg = colors.markdown_inline_code or "#77d5a3" },
    markdownCodeBlockDelimiter = { fg = colors.markdown_code or "#92a9ff" },
    markdownBlockquote = { fg = colors.markdown_quote or "#77d5a3" },
    markdownQuote = { fg = colors.markdown_quote or "#77d5a3" },
    markdownLink = { fg = colors.markdown_link or "#77d5a3", underline = true },
    markdownLinkText = { fg = colors.markdown_link or "#77d5a3" },
    markdownUrl = { fg = colors.markdown_link or "#77d5a3", underline = true },
    markdownListMarker = { fg = colors.markdown_list or "#ffd395" },
    markdownOrderedListMarker = { fg = colors.markdown_list or "#ffd395" },
    markdownStrikethrough = { fg = colors.markdown_strikethrough or "#ffc6d0", strikethrough = true },
    markdownEscape = { fg = colors.fg },
    markdownRule = { fg = colors.border },
    
    -- Treesitter markdown
    ["@markup.heading"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.1"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.2"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.3"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.4"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.5"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.heading.6"] = { fg = colors.markdown_heading or "#92a9ff", bold = true },
    ["@markup.strong"] = { fg = colors.markdown_bold or "#ffd395", bold = true },
    ["@markup.italic"] = { fg = colors.markdown_italic or "#85cdf1", italic = true },
    ["@markup.quote"] = { fg = colors.markdown_quote or "#77d5a3" },
    ["@markup.strikethrough"] = { fg = colors.markdown_strikethrough or "#ffc6d0", strikethrough = true },
    ["@markup.link"] = { fg = colors.markdown_link or "#77d5a3", underline = true },
    ["@markup.link.url"] = { fg = colors.markdown_link or "#77d5a3", underline = true },
    ["@markup.list"] = { fg = colors.markdown_list or "#ffd395" },
    ["@markup.list.numbered"] = { fg = colors.markdown_list or "#ffd395" },
    ["@markup.list.unnumbered"] = { fg = colors.markdown_list or "#ffd395" },
    ["@markup.raw"] = { fg = colors.markdown_code or "#92a9ff" },
    ["@markup.raw.block"] = { fg = colors.markdown_code or "#92a9ff", bg = colors.line_highlight },
    ["@markup.raw.inline"] = { fg = colors.markdown_inline_code or "#77d5a3" },
